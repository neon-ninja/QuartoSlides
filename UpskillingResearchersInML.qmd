...
- [Google Colab](https://colab.research.google.com/) - browser-based Jupyter notebook using Google resources (a virtual machine, GPU can be added)
...
::: {.column}
![](./UpskillingResearchersInML_Assets/colab2.jpg)
:::
::::
...
TODO illustration MAYBE TILES OF LIGHTNING TALK PLOTS?
...
- Model architectures
  ...
  - Recurrent neural network (sequences, times series)
- Model training
