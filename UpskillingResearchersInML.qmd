...
- [Google Colab](https://colab.research.google.com/) (a browser-based Jupyter Notebook using Google infrastructure (a virtual machine, GPU can be added))
...
- No need for GPU to start (or small ones on Colab available)
